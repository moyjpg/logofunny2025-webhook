...
function buildPromptFromBody(body) {
  ...
  if (industry) {
    ...
    if (industryLower.includes("tech") || industryLower.includes("technology")) {
      baseParts.push("modern software brand feel, abstract, minimal, digital-first, calm geometric identity");
...
if (keywords) {
  baseParts.push(`abstract geometric brand mark inspired by: ${keywords}`);
}
